...
2025-02-16
 */
public class LargestDistancedSequence_1718 {
    ...
    public static void main(String[] args) {
        int n = 3;
        LargestDistancedSequence_1718 sol = new LargestDistancedSequence_1718();
        System.out.println(Arrays.toString(sol.constructDistancedSequence(n)));
    }
