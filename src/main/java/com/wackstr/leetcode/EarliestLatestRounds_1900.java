...
2025-07-12
 */
public class EarliestLatestRounds_1900 {
    ...
    public static void main(String[] args) {
        ...
        int firstPlayer = 2;
        int secondPlayer = 4;
        EarliestLatestRounds_1900 sol = new EarliestLatestRounds_1900();
        System.out.println(Arrays.toString(sol.earliestAndLatest(
