...
public class BalanceTree_1382 {
    ...
    public static void main(String[] args) {
        TreeNode root = TreeNode.fromArray(new Integer[]{1,null,2,null,3,null,4,null,null});
        BalanceTree_1382 sol = new BalanceTree_1382();
        System.out.println(sol.balanceBST(root));
    }
